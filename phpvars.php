...
// php to loop through all global vars, then sort them by the strlen of their json_encoded value


	$glens = array();
	foreach ( array_keys( $GLOBALS ) as $k ) {
		$glens[ mb_strlen( json_encode( $GLOBALS[ $k ], JSON_UNESCAPED_SLASHES | JSON_PARTIAL_OUTPUT_ON_ERROR | JSON_UNESCAPED_UNICODE ) ) ] = $k;
	}
	krsort( $glens );
	var_export( $glens );
